...
namespace port {
    ...
    struct optional {
        ...
        inline explicit optional(const T &value) : m_Value(value), m_Present(true) { };
    ...
    public:
        ...
        /**
         * @brief Atribui um elemento à uma posição do vetor, alocando elementos antecessores caso necessário.
         * @returns `true` se o elemento foi atribuído, `false` se o índice é inválido.
         */
        ...
        /**
         * @brief Insere um elemento numa posição do vetor, movendo os elementos posteriores.
         * @returns `true` se o elemento foi inserido, `false` se o vetor está cheio ou o índice é inválido.
         */
        ...
        /**
         * @brief Remove um elemento de uma posição do vetor, movendo os elementos posteriores.
         * @returns O elemento, ou `nullopt` se o vetor está vazio ou o índice é inválido.
         */
        ...
        /**
         * @brief Move um elemento de um índice para outro, movendo elementos intermediários.
         * O mesmo que `sv.remove(from); sv.insert(..., to)`, porém otimizado.
