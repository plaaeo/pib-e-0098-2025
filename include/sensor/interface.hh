...
namespace sensor {
    /**
     * @brief Uma interface genérica para medir interfaces analógicas. Implementado para permitir a troca
     * entre o uso de ADCs externos e internos sem necessidade de adaptar código.
     */
    ...
    public:
        ...
        /**
         * @brief Define a tensão de referência para leituras da interface analógica.
         * Esta função NÃO executa `analogReference`.
         * 
         * @note Ao utilizar em uma placa ESP32, esta função não influenciará
         * o resultado das leituras, pois o framework `arduino-esp32` já realiza
         * conversões de leituras para milivolts com correção de erro.
