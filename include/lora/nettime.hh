...
namespace lora {
    ...
    struct NetworkTimer {
         ...
         * @param monoTimeAtRx_us O resultado de `port::get_monotonic_time()` no momento exato em que
         * o pacote foi recebido (deve ser executado ao receber um IRQ do radio para maior precisão).
         */
        void synchronize(port::time_us externalTimestamp_us, port::time_us monoTimeAtRx_us);
    };
}