 ...
 * transmitir eficientemente coletas de sensores via LoRa.
 */
struct CompressedReading
{
     ...
     */
    constexpr static auto BIT_SIZE = sizeof(uint32_t) * 8 + META_PH.bits +
                                     META_TDS.bits + META_TEMPERATURE.bits;
